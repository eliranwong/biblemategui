...
def original_interlinear(gui=None, b=1, c=1, v=1, area=1, tab1=None, tab2=None, **_):
    ...
    db = os.path.join(BIBLEMATEGUI_DATA, "original", "OIB.bible")
    ...
    bible_selector.create_ui("OIB", b, c, v)
